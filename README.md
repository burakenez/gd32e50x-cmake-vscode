[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32e50x-cmake-vscode)](https://github.com/burakenez/gd32e50x-cmake-vscode/tags/)

# GD32E50x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32E50x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32E50x Demo Suites V1.8.0](https://www.gd32mcu.com/en/download)_** and **_[GD32E50x Firmware Library V1.7.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32e50x-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32E50x**
- **Version:** `V1.7.0 (2026-02-09)`
- **Path:** `Drivers/CMSIS/GD/GD32E50x`
- **Source:** `GD32E50x Demo Suites V1.8.0`

### 3. **GD32E50x_usbd_library**
- **Version:** `V1.8.0 (2026-02-10)`
- **Path:** `Drivers/GD32E50x_usbd_library`
- **Source:** `GD32E50x Demo Suites V1.8.0`

### 4. **GD32E50x_standard_peripheral**
- **Version:** `V1.7.0 (2026-02-09)`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32e50x_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32e50x_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32e50x_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32e50x.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32e50x.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32E503C_START              # Board support package for GD32E503C_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32E50x
│           │   └── GD32E50x_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32e50x_flash.ld  # Linker script (memory regions)
│           └── GD32E50x.svd             # SVD file for peripheral register views
